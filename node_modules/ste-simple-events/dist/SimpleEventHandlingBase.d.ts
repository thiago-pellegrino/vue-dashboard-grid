 ...
 */
export declare abstract class SimpleEventHandlingBase<TArgs> extends HandlingBase<ISimpleEventHandler<TArgs>, SimpleEventDispatcher<TArgs>, SimpleEventList<TArgs>> implements ISimpleEventHandling<TArgs> {
    constructor();
}
